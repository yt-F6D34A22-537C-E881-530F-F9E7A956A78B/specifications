...
- PC では親ラベルを min-width: 200px の固定幅とし、隣接する exclude-markets-fieldset を flex: 1 1 auto・width: 100% で残り幅に伸長させることで右側の余白を吸収する。
